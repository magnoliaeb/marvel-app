...
export default {
  ...
  created() {
    ...
    this.getStoriesByComic(this.id,this.porPagina, 0);
  },
  
  methods: {

    getStoriesByComic(id, limit, offset) {
      this.isLoading = true;
      serviceMarvel.getStoriesByComic(id, limit, offset).then(data => {
